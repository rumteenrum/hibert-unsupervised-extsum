...
from fairseq.data import (
    data_utils, Dictionary, FlexibleDictionary, LanguagePairDataset, LongExtractSumDataset, IndexedInMemoryDataset,
...
@register_task('long_extractive_summarization')
class LongExtractiveSummarizationTask(FairseqTask):
    ...
    def load_dataset(self, split, shuffle=True):
        ...
        self.datasets[split] = LongExtractSumDataset(
