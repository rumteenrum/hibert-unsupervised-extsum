...
class ExtractiveSummarizationTask(FairseqTask):
    ...
    def load_dataset(self, split, shuffle=True):
        ...
        self.datasets[split] = ExtractSumDataset(
    ...
    def load_pretrained_model(self, model, state_file_name):
        ...
        state = torch.load(state_file_name, map_location=lambda s, l: default_restore_location(s, 'cpu'), weights_only=False) ###
        params = state['model']
