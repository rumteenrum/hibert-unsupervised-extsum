...
from fairseq.data import (
    data_utils, Dictionary, SubsetDataset, IndexedInMemoryDataset,
...
@register_task('subseq_selecting')
class SubseqSelectingTask(FairseqTask):
    ...
    def load_dataset(self, split):
        ...
        # load pointer dataset
        # ptr_dataset = indexed_dataset(prefix + self.args.pointer_lang, self.tgt_dict)
        ptr_dataset = IndexedInMemoryDataset(prefix + self.args.pointer_lang, fix_lua_indexing=True)
        print('load pointer dataset [always in memory (int)] done!')
        import sys
        sys.stdout.flush()

        self.datasets[split] = SubsetDataset(
            src_dataset, src_dataset.sizes, self.src_dict,
            tgt_dataset, tgt_dataset.sizes, self.tgt_dict,
            ptr_dataset, ptr_dataset.sizes,
