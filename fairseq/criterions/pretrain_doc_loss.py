...
@register_criterion('pretrain_doc_loss')
class PretrainDocLoss(FairseqCriterion):
    ...
    def forward(self, model, sample, reduce=True):
        ...
        probs = model.get_normalized_probs(net_output, log_probs=False, idx=0) #####
        ...
        loss = loss * self.masked_sent_loss_weight + lbl_nll_loss * self.sent_label_weight
