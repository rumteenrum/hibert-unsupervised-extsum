...
class BertTransformerModel(FairseqModel):
...
@register_model_architecture('bert_transformer', 'bert_transformer_wmt_en_de')
def transformer_wmt_en_de(args):
    base_architecture(args)


# parameters used in the "Attention Is All You Need" paper (Vaswani, et al, 2017)
@register_model_architecture('bert_transformer', 'bert_transformer_vaswani_wmt_en_de_big')
...
@register_model_architecture('bert_transformer', 'bert_transformer_vaswani_wmt_en_fr_big')
...
@register_model_architecture('bert_transformer', 'bert_transformer_wmt_en_de_big_t2t')
