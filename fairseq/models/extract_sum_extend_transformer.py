...
@register_model('extract_sum_extend_transformer')
class ExtractSumExtendTransformerModel(FairseqModel):
    ...
    def build_model(cls, args, task):
        ...
        return ExtractSumExtendTransformerModel(encoder, decoder)
...
class TransformerSentenceEncoder(FairseqEncoder):
    ...
    def forward(self, src_tokens, doc_pad_mask, doc_pos_tok):
        ...
        return {
            'encoder_out': x,  # bsz * n_sent x C
            'encoder_padding_mask': encoder_padding_mask,  # bsz * n_sent x seqlen
        }
...
class TransformerDocumentEncoder(FairseqEncoder):
    """Transformer encoder."""
    ...
    def forward(self, src_tokens, sent_encoder_out, doc_pad_mask, doc_pos_tok):
        bsz, n_sent, seqlen = src_tokens.size()
    ...
    def max_positions(self):
        """Maximum input length supported by the encoder."""
        return self.sent_embed_positions.max_positions()

    def upgrade_state_dict(self, state_dict):
        if isinstance(self.sent_embed_positions, SinusoidalPositionalEmbedding):
            if 'encoder.embed_positions.weights' in state_dict:
                del state_dict['encoder.embed_positions.weights']
            if 'encoder.embed_positions._float_tensor' not in state_dict:
                state_dict['encoder.embed_positions._float_tensor'] = torch.FloatTensor()
...
@register_model_architecture('extract_sum_extend_transformer', 'extract_sum_extend_transformer')
...
@register_model_architecture('extract_sum_extend_transformer', 'extract_sum_extend_transformer_iwslt_de_en')
...
@register_model_architecture('extract_sum_extend_transformer', 'extract_sum_extend_transformer_wmt_en_de')
def transformer_wmt_en_de(args):
    base_architecture(args)


# parameters used in the "Attention Is All You Need" paper (Vaswani, et al, 2017)
@register_model_architecture('extract_sum_extend_transformer', 'extract_sum_extend_transformer_vaswani_wmt_en_de_big')
...
@register_model_architecture('extract_sum_extend_transformer', 'extract_sum_extend_transformer_vaswani_wmt_en_fr_big')
def transformer_vaswani_wmt_en_fr_big(args):
    args.dropout = getattr(args, 'dropout', 0.1)
    transformer_vaswani_wmt_en_de_big(args)


@register_model_architecture('extract_sum_extend_transformer', 'extract_sum_extend_transformer_wmt_en_de_big')
...
@register_model_architecture('extract_sum_extend_transformer', 'extract_sum_extend_transformer_wmt_en_de_big_t2t')
