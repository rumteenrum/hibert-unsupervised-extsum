...
@register_model('extract_sum_long_transformer')
class ExtractSumLongTransformerModel(FairseqModel):
    ...
    def build_model(cls, args, task):
        ...
        return ExtractSumLongTransformerModel(encoder, decoder)
...
@register_model_architecture('extract_sum_long_transformer', 'extract_sum_long_transformer')
...
@register_model_architecture('extract_sum_long_transformer', 'extract_sum_long_transformer_iwslt_de_en')
...
@register_model_architecture('extract_sum_long_transformer', 'extract_sum_long_transformer_wmt_en_de')
def transformer_wmt_en_de(args):
    base_architecture(args)


# parameters used in the "Attention Is All You Need" paper (Vaswani, et al, 2017)
@register_model_architecture('extract_sum_long_transformer', 'extract_sum_long_transformer_vaswani_wmt_en_de_big')
...
@register_model_architecture('extract_sum_long_transformer', 'extract_sum_long_transformer_vaswani_wmt_en_fr_big')
def transformer_vaswani_wmt_en_fr_big(args):
    args.dropout = getattr(args, 'dropout', 0.1)
    transformer_vaswani_wmt_en_de_big(args)


@register_model_architecture('extract_sum_long_transformer', 'extract_sum_long_transformer_wmt_en_de_big')
...
@register_model_architecture('extract_sum_long_transformer', 'extract_sum_long_transformer_wmt_en_de_big_t2t')
