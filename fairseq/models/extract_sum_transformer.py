...
@register_model('extract_sum_transformer')
class ExtractSumTransformerModel(FairseqModel):
    ...
    def build_model(cls, args, task):
        ...
        return ExtractSumTransformerModel(encoder, decoder)
...
@register_model_architecture('extract_sum_transformer', 'extract_sum_transformer')
...
@register_model_architecture('extract_sum_transformer', 'extract_sum_transformer_iwslt_de_en')
...
@register_model_architecture('extract_sum_transformer', 'extract_sum_transformer_wmt_en_de')
def transformer_wmt_en_de(args):
    base_architecture(args)

# Medium size transformer
@register_model_architecture('extract_sum_transformer', 'extract_sum_transformer_medium')
...
@register_model_architecture('extract_sum_transformer', 'extract_sum_transformer_vaswani_wmt_en_de_big')
...
@register_model_architecture('extract_sum_transformer', 'extract_sum_transformer_vaswani_wmt_en_fr_big')
def transformer_vaswani_wmt_en_fr_big(args):
    args.dropout = getattr(args, 'dropout', 0.1)
    transformer_vaswani_wmt_en_de_big(args)


@register_model_architecture('extract_sum_transformer', 'extract_sum_transformer_wmt_en_de_big')
...
@register_model_architecture('extract_sum_transformer', 'extract_sum_transformer_wmt_en_de_big_t2t')
